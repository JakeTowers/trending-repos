...
It can also be manually deployed using a GitHub Action workflow. This is in case you need to rollback, you can provide the GitHub Commit SHA and deploy that version of the application.
